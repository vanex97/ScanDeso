...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        <h1 class="h2 mb-3">Scandeso parsing status</h1>
    </div>
    ...
    <div class="border info-table">
        ...
        <div class="row m-2 mb-3">
            <div class="col-md-3">Users parsed:</div>
            <div class="col-md-9 text-break">{{ $usersParsed }}</div>
        </div>
        <div class="row m-2 mb-3">
            <div class="col-md-3">Usernames parsed:</div>
            <div class="col-md-9 text-break">{{ $userNamesParsed }}</div>
        </div>
@endsection
